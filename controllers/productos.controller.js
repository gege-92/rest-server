...
//obtenerProducto - populate - devuelve objeto
...
const crearProducto = async (req = request, res = response) => {
    ...
    // Generar la data que quiero guardar en la BD
    const data = {
        ...body,
...
const actualizarProducto = async(req = request, res = response) => {
    ...
    //const producto = await Producto.findById( id );  --> middleware personalizado(existeProductoPorId) validado
